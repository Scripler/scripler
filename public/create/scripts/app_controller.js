	...
	return {
		...
		link: function(scope, elm, attr, ngModel) {
			var ck = CKEDITOR.replace('bodyeditor', {
				...
				extraPlugins: 'scripler,floating-tools,lineHeight,texttransform,indent-right,indentations,scripler_pagebreak,scripler_pagebreakavoid',
				floatingtools: 'Basic',
				floatingtools_Basic: [
				...
				contentsCss: ['stylesets/pleasant-bw.css', 'stylesets/non-editable.css'],
