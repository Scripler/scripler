(function(service) {
	...
	/**
	*
	* Move items arround in an array with safety check for negative indexes
	* old_index item that you want to move
	* new_index where to move the item
	* can be called as .move(0,1) on any array
	*
	**/
