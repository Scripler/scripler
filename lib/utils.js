...
/**
 * In the input string "string", replace all occurrences of each element of the array "find" with the corresponding (by index) value of the array "replace".
 *
 * Copied from http://stackoverflow.com/questions/5069464/replace-multiple-strings-at-once
 *
 * @param find
 * @param replace
 * @returns {boolean}
 */
exports.replaceArray = function ( string, find, replace ) {
	var regex;
