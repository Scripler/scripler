...
exports.getStorageLimitErrorMessage = function (userLevel, storageLimitBytes) {
	var errorMessage = "You have reached your storage quota of " + storageLimitBytes/1000000 + " MB. ";
	// TODO: add "upgrade" link to error message once upgrade functionality has been implemented (https://trello.com/c/RPdVqlez/58-premium-plan-payment-p1-27)
	userLevel == 'free' ? errorMessage += "Please upgrade to Premium to get more space or delete one or more archived ebooks to free up some space." : errorMessage += "Please delete one or more archived ebooks to free up some space.";
	return errorMessage;
}
