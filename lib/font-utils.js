		...
		if (type) {
			if (type == 'fontface') {
				...
				Font.findOne({"family": family, "style": style, "weight": weight, "isSystem": true}, function (err, font) {
					...
					if (!font) {
						//console.log('Font family ' + family + ', style: ' + style + ', weight ' + weight + ' does not exist, creating it...');
						font = new Font({
							family: family,
							style: style,
							weight: weight,
						...
						//console.log('Font family ' + family + ', style: ' + style + ', weight ' + weight + ' already exists, updating its src...');
						font.src = src;
					}
					...
					font.save(function (err, font) {
						...
						fonts.push(font);
						console.log('Created/updated font: ' + JSON.stringify(font));
						callback(null);
					});
				});
			} else if (type == 'style') {
